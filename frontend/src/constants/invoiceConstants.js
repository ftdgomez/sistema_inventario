...
export const INVOICE_CREATE_REVIEW_REQUEST = 'INVOICE_CREATE_REVIEW_REQUEST'
export const INVOICE_CREATE_REVIEW_SUCCESS = 'INVOICE_CREATE_REVIEW_SUCCESS'
export const INVOICE_CREATE_REVIEW_FAIL = 'INVOICE_CREATE_REVIEW_FAIL'
export const INVOICE_CREATE_REVIEW_RESET = 'INVOICE_CREATE_REVIEW_RESET'

export const INVOICE_TOP_REQUEST = 'INVOICE_TOP_REQUEST'
export const INVOICE_TOP_SUCCESS = 'INVOICE_TOP_SUCCESS'
export const INVOICE_TOP_FAIL = 'INVOICE_TOP_FAIL'
